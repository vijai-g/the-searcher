...
- Provider resolution is automatic (`LLM_PROVIDER=auto`): inside a codemie-Codex
  session the organiser uses Codex through the CodeMie proxy with no key; outside
